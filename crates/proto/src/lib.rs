...
mod proto {
    #![expect(
        ...
        reason = "Generated by tonic/protobuf; lints are not controllable in generated code"
    )]
...
pub use self::proto::{
    ...
    ListResponse, MarkRequest, MarkResponse, RemoveRequest, RemoveResponse, SubscribeEvent,
    SubscribeRequest, UpdateRequest, UpdateResponse, WatcherState, WatcherStateReply,
